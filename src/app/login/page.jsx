              ...
              <CardContent className="p-6">
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100 dark:border-zinc-800/80">
                    <p className="text-xs font-semibold text-slate-500 dark:text-zinc-400 mb-2.5 text-center">
                      Quick Demo Accounts:
                    </p>
                    <div className="grid grid-cols-3 gap-2">
                      <button
                        type="button"
                        onClick={() => {
                          setEmail("tenant@renterty.com");
                          setPassword("tenantpassword123");
                        }}
                        className="py-1.5 px-2 bg-slate-100 hover:bg-teal-50 dark:bg-zinc-800 dark:hover:bg-teal-950/40 text-slate-700 dark:text-zinc-300 hover:text-teal-600 dark:hover:text-teal-400 rounded-lg text-xs font-semibold transition border border-transparent hover:border-teal-200 dark:hover:border-teal-800 cursor-pointer"
                      >
                        Tenant
                      </button>
                      <button
