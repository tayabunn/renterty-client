  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-lg bg-teal-50/70 dark:bg-teal-950/30 border border-teal-200 dark:border-teal-500/20 text-teal-900 dark:text-teal-200 text-xs sm:text-sm">
