...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-slate-400 dark:bg-zinc-950 dark:border-t dark:border-zinc-900 border-t border-slate-200 py-12 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2 text-white font-bold text-xl">
              ...
              <span className="text-xl tracking-tight bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">
                Renterty
              </span>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-2 bg-slate-800 dark:bg-zinc-900 text-slate-400 hover:text-white hover:bg-teal-500 rounded-xl transition-all duration-200"
        ...
        <div className="mt-8 pt-8 border-t border-slate-800 dark:border-zinc-900 flex flex-col md:flex-row justify-between items-center text-xs">
