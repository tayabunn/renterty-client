        ...
        <>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            {user.photo ? (
              ...
              <div className="h-24 w-24 rounded-full linear-gradient-to-tr from-teal-500 to-emerald-500 text-white flex items-center justify-center font-bold text-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="relative group">
              {previewUrl ? (
                ...
                <div className="h-24 w-24 rounded-full linear-gradient-to-tr from-teal-500 to-emerald-500 text-white flex items-center justify-center font-bold text-4xl shadow-md group-hover:opacity-75 transition-opacity duration-200">
