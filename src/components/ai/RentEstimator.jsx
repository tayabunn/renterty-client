...
export default function RentEstimator({
  ...
  return (
    <div className="p-4 bg-linear-to-br from-emerald-500/10 via-teal-500/5 to-transparent dark:from-emerald-950/30 dark:via-teal-950/20 dark:to-transparent border border-emerald-500/20 rounded-2xl space-y-3">
